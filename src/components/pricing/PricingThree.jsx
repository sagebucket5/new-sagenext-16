...
import Classes from "@styles/component/pricing/pricingthree.module.css";
  ...
  return (
    <div className="container mx-auto">
      <div className="w-11/12 mx-auto">
        <div className="flex">
          <div className={`${Classes["ButtonMainCont"]} w-full mb-10`}>
            <div className="flex flex-wrap">
              <div className="w-6/12 flex flex-col justify-end">
                <div className={Classes["ButtonContain"]}>
                  <div className="">
                    <p id="monthly" className={sharedActive ? `${Classes.active}` : ""} onClick={handleSharedClick}>SHARED</p>
                  </div>
                  <div>
                    <p id="yearly" className={!sharedActive ? `${Classes.active}` : ""} onClick={handleDedicatedClick}>DEDICATED</p>
                  </div>
                </div>
              </div>
              <div className={`${Classes["ViewPlanMain"]} md:w-6/12 w-12/12`}>
                <div className={Classes["toggle-btn"]}>
                  ...
                  <span className={Classes.MoreSave}> ( Save <strong style={{ fontWeight: "800" }}>10%</strong> More )</span>
                </div>
              </div>
        ...
        <div
          className={`grid grid-cols-3 ${Classes["monthlyPriceList"]} ${sharedActive ? `${Classes.SharedActive}` : "hidden"} mt-5`}
        >
          ...
          <div className={`${Classes["InterMediateDiv"]} col-span-1`}>
          ...
          <div className="px-4 col-span-1">
            <div className={Classes["Advance1"]}>
              ...
              <div className="btn mt-4 mb-4">
                <BlueCta text1="Get Free Trial Now"
        ...
        <div
          className={`grid grid-cols-3 ${Classes["monthlyPriceList"]} ${dedicatedActive ? `${Classes.DedicatedActive}` : "hidden"} mt-3`}
        >
