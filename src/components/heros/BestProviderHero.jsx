  ...
  return (
    <div className="bg-[url('https://sage-storage.sfo3.cdn.digitaloceanspaces.com/public/assets/images/offer/herobg.webp')] bg-cover bg-center z-[2] relative">
      <img
        ...
        height={200}
        loading="lazy"
        className="max-xl:hidden object-contain absolute right-[34dvw] 2xl:right-[40dvw] top-1/4 -rotate-[15deg]"
      />
      <div className="max-w-[1350px] mx-auto pt-16 md:pt-28 px-2 lg:px-0">
        <div className="grid grid-cols-1 xl:grid-cols-2  pb-10 items-center">
          ...
          <div className={` lg:pb-0 !pb-10 ${styles2.leftContent}`}>
            ...
            {/* Main Headline */}
            <h1 className={"text-center xl:text-start leading-[123%]"}>
              Best QuickBooks Cloud Hosting Providers
            </h1>

            {/* Description */}
            <p className="lg:!text-[20px] opacity-90 !font-medium !text-[17px] !text-[#ffffff] text-center xl:text-start">
              Access QuickBooks applications & addons remotely from anywhere,
              anytime. With the best QuickBooks cloud hosting providers like
              Sagenext, you can securely streamline your entire workflow.
            </p>
            ...
            <div className={styles2.ctaButtons}>
              <Link
                ...
                className={styles2.phoneButton}
              >
                <BiPhone
                  className={styles2.phoneIcon}
                  size={20}
                />{" "}
                +1-855-922-7243
                <svg
                  className={styles2.polygon}
                ...
                >
                  <path
                    fill="#EDF3FD"
                    fillOpacity=".13"
                    d="M45.716-16.893 45.042 85.04l-88.276-52.147 88.95-49.786Z"
                  />
                </svg>
              </Link>
              <Link
                href="/pricing"
                className={styles2.pricingButton}
              >
                Check Pricing & Plan
              </Link>
            </div>
          ...
          {/* Right Form Section */}
          <div
            className="border border-white bg-[rgba(255,225,225,0.12)] rounded-[34px] max-w-[450px] w-full p-2.5 xl:ml-auto xl:mr-4 mr-auto ml-auto h-full lg:max-h-[615px] z-10"
            id="form-section"
          >
            <div
              className="md:p-[35px_35px_30px_35px] p-5 bg-white h-full rounded-[25px]"
              id="form"
            >
              <div className="text-center mb-[26px]">
                <h3
                  style={{ fontWeight: "900 !important" }}
                  className="!text-[#2355FA] !text-[26px] leading-[33px]"
                >
                  Get A Free Quote Today
                </h3>
                <p className="!text-[#020202] md:!text-[15px] !text-[13px] font-light !leading[33px] mb-3">
              ...
              >
                ...
                <button
                  type="submit"
                  className="submitButton appearance-none"
                >
                  {isSubmit ? "Wait..." : "Get Started"}
                </button>
                <p className="!text-[#444444] !text-[10px] !leading-3 text-center !mb-0 -mt-2.5">
...
export default BestProviderHero;
