    ...
    <div className={styles.offerWrapper}>
      <div className={styles.mainContent}>
        <div className={styles.leftContent}>
          ...
          {/* CTA Buttons */}
          <div
            className={`${styles.ctaBtns} grid grid-cols-1 md:grid-cols-2 items-center justify-start md:container gap-4 md:gap-2 my-6 -mx-1 font-semibold w-full md:w-11/12`}
          >
            {props.cta ? props.cta : ""}
          </div>
        ...
        {props.BannerImage && (
          <Image src={props.BannerImage} alt={props.title} className={`${styles.BannerImage}`} width={468} height={575} loading="eager" fetchPriority="high" />
        )}
      </div>
    </div>
  );
