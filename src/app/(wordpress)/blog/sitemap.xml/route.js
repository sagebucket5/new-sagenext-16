const EXTERNAL_DATA_URL =
  "https://snb.thesagenext.com/blog/index.php/wp-json/wp/v2";
...
function generateSiteMap(categories, slugs) {
  ...
  ${categoryEntries}
  <url>
    <loc>https://www.thesagenext.com/blog/author/toby-nwazor</loc>
    <lastmod>2025-12-24T02:03:20+00:00</lastmod>
    <priority>0.80</priority>
  </url>
  <url>
    <loc>https://www.thesagenext.com/blog/author/mark-calatrava</loc>
    <lastmod>2025-12-24T02:03:20+00:00</lastmod>
    <priority>0.80</priority>
  </url>
  <url>
    <loc>https://www.thesagenext.com/blog/author/mohit-gupta</loc>
    <lastmod>2025-12-24T02:03:20+00:00</lastmod>
    <priority>0.80</priority>
  </url>
  </urlset>`;
  ...
  try {
    ...
    return new Response(xml, {
      headers: {
        ...
        "Cache-Control":
          "public, s-maxage=3600, max-age=3600, stale-while-revalidate=3900",
      },
    });
  } catch (error) {
