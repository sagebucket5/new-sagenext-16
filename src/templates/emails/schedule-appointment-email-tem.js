...
const ScheduleAppointmentEmailTemplate = (data, ipData) => {
  return `
          ...
          <table style="width: 100%">
              ...
              <tr>
                  <th style="border-bottom: 1px solid #dddddd;
                  border-right: 1px solid #dddddd;
                  padding: 8px;width: 50%;">Best method for contacting you</th>
                  <td style="border-bottom: 1px solid #dddddd;
                  border-left: 1px solid #dddddd;
                  padding: 8px;width: 50%;">${data.contactingYou}</td>
              </tr>
              <tr>
                  <th style="border-bottom: 1px solid #dddddd;
                  border-right: 1px solid #dddddd;
...
export default ScheduleAppointmentEmailTemplate;
